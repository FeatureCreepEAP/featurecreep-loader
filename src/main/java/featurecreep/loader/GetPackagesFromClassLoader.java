...
public interface GetPackagesFromClassLoader {
  ...
  public static String[] getPackageNamesInCurrentClassLoader() //Soon we will need to get one for others, but it is currently harder in java 8 vanilla classloaders, JBM Classloaders are easier though for it
  {
